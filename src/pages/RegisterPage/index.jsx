      ...
      <div className="bg-white-A700 flex flex-col font-mazzard items-center justify-start mx-auto w-full">
        <div className="flex md:flex-col flex-row md:gap-10 items-start justify-between w-full">
          <div className="flex flex-col md:gap-10 gap-[74px] justify-start md:mt-0 mt-5 md:px-5">
            <div className="md:h-[127px] h-[132px] relative w-[43%]">
              ...
              <Img
                ...
                src="images/img_rectangle34626545_1.png"
                alt="rectangle346265"
              />
            </div>
            <div className="flex flex-col items-start justify-start md:ml-[0] ml-[99px] w-[78%] md:w-full">
              ...
              ></Input>
              <Button
                className="cursor-pointer font-semibold leading-[normal] min-w-[337px] mt-[51px] text-center text-lg"
                shape="round"
                size="lg"
              >
                Register
              </Button>
              <div className="flex flex-col items-center justify-start ml-14 md:ml-[0] mt-[42px] w-[62%] md:w-full">
              ...
              <div className="flex flex-col gap-[33px] items-center justify-start ml-2.5 md:ml-[0] mt-11 w-[94%] md:w-full">
                <div className="flex flex-row items-start justify-evenly w-full">
                  ...
                  <Line className="bg-black-900_38 h-px my-2 w-[28%]" />
                </div>
                <div className="flex flex-row gap-[17px] items-start justify-start pt-2.5 w-auto">
                  <Img
          ...
          <Img
            ...
            src="images/img_rectangle34626678_1024x716.png"
            alt="rectangle346266"
          />
        </div>
      </div>
